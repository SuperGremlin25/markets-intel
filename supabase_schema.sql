...
CREATE POLICY "Allow service role to insert market snapshots" ON market_snapshots
    FOR INSERT WITH CHECK (true);

-- Policy: Allow reads for everyone (public data)
CREATE POLICY "Allow public read access to market snapshots" ON market_snapshots
